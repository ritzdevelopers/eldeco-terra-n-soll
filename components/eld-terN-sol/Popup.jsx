      ...
      >
        ...
        <div className="p-5 pt-14 sm:p-8 sm:pt-12 lg:p-10">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <button
              type="submit"
              className="group mt-1 flex w-full items-center justify-center gap-3 rounded-full bg-eld-bronze-deep px-6 py-[14px] text-[13px] font-bold text-white uppercase transition-opacity hover:opacity-90"
            >
              {sent ? "Request Received" : "Submit Enquiry"}
